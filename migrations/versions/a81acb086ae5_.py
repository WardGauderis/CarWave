...
Revision ID: a81acb086ae5
Revises: 
Create Date: 2020-04-02 10:37:47.544929
...
def upgrade():
    ...
    op.create_table('rides',
                    ...
                    sa.Column('departure_address', geoalchemy2.types.Geometry(geometry_type='POINT', srid=4326),
                              nullable=False),
                    sa.Column('arrival_time', sa.DateTime(), nullable=False),
                    sa.Column('arrival_address', geoalchemy2.types.Geometry(geometry_type='POINT', srid=4326),
                              nullable=False),
                    sa.ForeignKeyConstraint(['driver_id'], ['drivers.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
