...
Revision ID: 69db09224eb2
Revises: 
Create Date: 2020-04-12 16:02:21.617887
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('user_id', 'car_license_plate')
    )
    ...
    sa.Column('departure_address', geoalchemy2.types.Geometry(geometry_type='POINT', srid=4326), nullable=False),
    sa.Column('arrival_time', sa.DateTime(), nullable=False),
    sa.Column('arrival_address', geoalchemy2.types.Geometry(geometry_type='POINT', srid=4326), nullable=False),
